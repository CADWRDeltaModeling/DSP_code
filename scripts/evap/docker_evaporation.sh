...
do
  ...
  docker run --rm -it -v .:/workdir -v /scratch/tomkovic/DSP_code/model/schism/azure_dsp_2024_lhc_v3/simulations/baseline_lhc_1:/data $DOCKER_IMAGE python evaporation_integrate.py --path_out2d /data/outputs/out2d_${NUMBER}.nc --path_polygons /data/evap_poly.shp --polygon_domain baseline
