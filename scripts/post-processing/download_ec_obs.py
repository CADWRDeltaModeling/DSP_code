...
obs_fns = {
    "des_bdl_49_ec_*.csv": "des_bdl_obs_ec_1990_2025.csv",
    "des_cse@upper_22_ec_*.csv": "des_cse_obs_ec_1990_2025.csv",
    "des_mrz@upper_40_ec_*.csv": "des_mrz_obs_ec_1990_2025.csv",
