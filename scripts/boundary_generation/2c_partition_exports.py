...
def partition_from_dss(in_dss_dir, hist_dss, mod_in_file, output_dir, out_csv_suffix):
    ...
    for b_part in exports_list:
        ...
        out_ts.to_csv(os.path.join(output_dir,f"{b_part}_{out_csv_suffix}.csv"), 
                        index=True,
                        header=False)
...
if __name__ == "__main__":
    ...
    # partition v1
    mod_in_file ="./data_out/Exports_1991-2019_perturb_historical_v1.csv"
    out_csv_suffix = "perturb_historical_v1"

    partition_from_dss(in_dss_dir, hist_dss, mod_in_file, output_dir, out_csv_suffix)

    # partition v2
    mod_in_file ="./data_out/Exports_1991-2019_perturb_historical_v2.csv"
    out_csv_suffix = "perturb_historical_v2"
