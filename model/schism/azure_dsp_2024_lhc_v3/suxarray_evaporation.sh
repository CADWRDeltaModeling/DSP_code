...
polygon_domain=$1 # getting the argument: baseline, franks, suisun, cache

for NUMBER in $(seq 1 $highest);
do
  python evaporation_integrate.py --path_out2d ./outputs/out2d_${NUMBER}.nc --path_polygons ./evap/evap_poly.shp --polygon_domain $polygon_domain
