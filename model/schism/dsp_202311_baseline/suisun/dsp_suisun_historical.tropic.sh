...
# generate .th.nc file
gen_elev2d --outfile suis.hist.elev2D.th.nc --hgrid=hgrid_dsp_suisun.gr3 --stime=2006-11-14 --etime=2008-12-31 --slr 0.0 ../noaa_download/pryc_filled_data.csv ../noaa_download/noaa_mtyc1_9413450_water_level_2006_2017.csv
