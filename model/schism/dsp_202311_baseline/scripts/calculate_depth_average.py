...
#     import os
#     os.chdir('/scratch/tomkovic/DSP_code/model/schism/dsp_202311_baseline/scripts/suisun/')
# # --varname salinity --date_base 2006-11-14 --date_start 2007-07-01 --date_end 2007-09-01 --path_study ../../
#     calculate_depth_average('salinity', '../../suisun', dt.datetime(2006,11,14),
#                             dt.datetime(2007,7,1),
#                             dt.datetime(2007,9,1))